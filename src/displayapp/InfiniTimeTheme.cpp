...
static void basic_init() {
  ...
  lv_style_set_text_color(&style_label_white, LV_STATE_DISABLED, PINETIME_COLOR_GRAY);
  ...
  lv_style_set_text_color(&style_btn, LV_STATE_DISABLED, PINETIME_COLOR_GRAY);
  ...
  lv_style_set_bg_color(&style_sw_knob, LV_STATE_DEFAULT, PINETIME_COLOR_SILVER);
  ...
  lv_style_set_bg_color(&style_slider_knob, LV_STATE_DEFAULT, PINETIME_COLOR_RED);
  ...
  lv_style_set_border_color(&style_table_cell, LV_STATE_DEFAULT, PINETIME_COLOR_GRAY);
  ...
  lv_style_set_scale_end_color(&style_lmeter, LV_STATE_DEFAULT, PINETIME_COLOR_GRAY);
