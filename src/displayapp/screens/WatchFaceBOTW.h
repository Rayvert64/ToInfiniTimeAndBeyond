...
namespace Pinetime {
  ...
  namespace Applications {
    namespace Screens {
      class WatchFaceBOTW : public Screen {
      public:
        WatchFaceBOTW(Controllers::DateTime& dateTimeController,
    ...
    struct WatchFaceTraits<WatchFace::PineTimeStyle> {
      ...
      static Screens::Screen* Create(AppControllers& controllers) {
        return new Screens::WatchFaceBOTW(controllers.dateTimeController,
