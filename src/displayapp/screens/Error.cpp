...
Error::Error(System::BootErrors error) {
  ...
  lv_obj_set_style_local_text_color(warningLabel, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, PINETIME_COLOR_ORANGE);
  lv_label_set_text_static(warningLabel, "Warning");
  lv_obj_align(warningLabel, nullptr, LV_ALIGN_TOP_MID, 0, 0);
  ...
  lv_obj_align(btnOk, lv_scr_act(), LV_ALIGN_BOTTOM_MID, 0, 0);
