...
WatchFacePineTimeStyle::WatchFacePineTimeStyle(Controllers::DateTime& dateTimeController,
  ...
  lv_obj_align(timebar, lv_scr_act(), LV_ALIGN_TOP_LEFT, 0, 0);
  ...
  lv_obj_align(timeDD1, timebar, LV_ALIGN_TOP_MID, 5, 5);
  ...
  lv_obj_align(timeDD2, timebar, LV_ALIGN_BOTTOM_MID, 5, -5);
  ...
  lv_obj_align(timeAMPM, timebar, LV_ALIGN_BOTTOM_LEFT, 2, -20);
  ...
  lv_obj_align(sidebar, lv_scr_act(), LV_ALIGN_TOP_RIGHT, 0, 0);

  // Display icons
  batteryIcon.Create(sidebar);
  batteryIcon.SetColor(lv_color_black());
  lv_obj_align(batteryIcon.GetObject(), nullptr, LV_ALIGN_TOP_MID, 10, 2);
  ...
  lv_obj_align(plugIcon, sidebar, LV_ALIGN_TOP_MID, 10, 2);
  ...
  lv_obj_align(bleIcon, sidebar, LV_ALIGN_TOP_MID, -10, 2);
  ...
  lv_obj_align(notificationIcon, timebar, LV_ALIGN_TOP_LEFT, 5, 5);

  weatherIcon = lv_label_create(lv_scr_act());
  ...
  lv_obj_align(weatherIcon, sidebar, LV_ALIGN_TOP_MID, 0, 35);
  ...
  lv_obj_align(temperature, sidebar, LV_ALIGN_TOP_MID, 0, 65);
  if (settingsController.GetPTSWeather() == Pinetime::Controllers::Settings::PTSWeather::On) {
  ...
  lv_obj_align(calendarBar1, calendarOuter, LV_ALIGN_TOP_MID, -6, -3);
  ...
  lv_obj_align(calendarBar2, calendarOuter, LV_ALIGN_TOP_MID, 6, -3);
  ...
  lv_obj_align(calendarCrossBar1, calendarBar1, LV_ALIGN_BOTTOM_MID, 0, 0);
  ...
  lv_obj_align(calendarCrossBar2, calendarBar2, LV_ALIGN_BOTTOM_MID, 0, 0);
  ...
  if (settingsController.GetPTSGaugeStyle() == Pinetime::Controllers::Settings::PTSGaugeStyle::Full) {
    ...
    lv_obj_align(stepGauge, sidebar, LV_ALIGN_BOTTOM_MID, 0, 0);
    ...
    lv_obj_align(stepGauge, sidebar, LV_ALIGN_BOTTOM_MID, 0, -10);
  ...
  lv_obj_align(stepValue, sidebar, LV_ALIGN_BOTTOM_MID, 0, 0);
  ...
  // Display seconds
  timeDD3 = lv_label_create(lv_scr_act());
  ...
  lv_obj_align(timeDD3, sidebar, LV_ALIGN_BOTTOM_MID, 0, 0);
  ...
  lv_obj_align(btnNextTime, lv_scr_act(), LV_ALIGN_RIGHT_MID, -15, -80);
  lv_obj_set_style_local_bg_opa(btnNextTime, LV_PART_MAIN, LV_STATE_DEFAULT, LV_OPA_50);
  ...
  lv_obj_align(btnPrevTime, lv_scr_act(), LV_ALIGN_LEFT_MID, 15, -80);
  lv_obj_set_style_local_bg_opa(btnPrevTime, LV_PART_MAIN, LV_STATE_DEFAULT, LV_OPA_50);
  ...
  lv_obj_align(btnNextBar, lv_scr_act(), LV_ALIGN_RIGHT_MID, -15, 0);
  lv_obj_set_style_local_bg_opa(btnNextBar, LV_PART_MAIN, LV_STATE_DEFAULT, LV_OPA_50);
  ...
  lv_obj_align(btnPrevBar, lv_scr_act(), LV_ALIGN_LEFT_MID, 15, 0);
  lv_obj_set_style_local_bg_opa(btnPrevBar, LV_PART_MAIN, LV_STATE_DEFAULT, LV_OPA_50);
  ...
  lv_obj_align(btnNextBG, lv_scr_act(), LV_ALIGN_RIGHT_MID, -15, 80);
  lv_obj_set_style_local_bg_opa(btnNextBG, LV_PART_MAIN, LV_STATE_DEFAULT, LV_OPA_50);
  ...
  lv_obj_align(btnPrevBG, lv_scr_act(), LV_ALIGN_LEFT_MID, 15, 80);
  lv_obj_set_style_local_bg_opa(btnPrevBG, LV_PART_MAIN, LV_STATE_DEFAULT, LV_OPA_50);
  ...
  lv_obj_set_style_local_bg_opa(btnReset, LV_PART_MAIN, LV_STATE_DEFAULT, LV_OPA_50);
  ...
  lv_obj_set_style_local_bg_opa(btnRandom, LV_PART_MAIN, LV_STATE_DEFAULT, LV_OPA_50);
  ...
  lv_obj_set_style_local_bg_opa(btnClose, LV_PART_MAIN, LV_STATE_DEFAULT, LV_OPA_50);
  ...
  lv_obj_set_style_local_bg_opa(btnSteps, LV_PART_MAIN, LV_STATE_DEFAULT, LV_OPA_50);
  ...
  lv_obj_set_style_local_bg_opa(btnWeather, LV_PART_MAIN, LV_STATE_DEFAULT, LV_OPA_50);
  ...
  lv_obj_set_style_local_bg_opa(btnSetColor, LV_PART_MAIN, LV_STATE_DEFAULT, LV_OPA_50);
  ...
  lv_obj_set_style_local_bg_opa(btnSetOpts, LV_PART_MAIN, LV_STATE_DEFAULT, LV_OPA_50);
